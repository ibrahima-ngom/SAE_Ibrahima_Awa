...
from controllers.client_jean import *
...
from controllers.admin_jean import *
from controllers.admin_declinaison_jean import *
from controllers.admin_commande import *
from controllers.admin_coupe_jean import *
...
app.register_blueprint(client_jean)
...
app.register_blueprint(admin_jean)
app.register_blueprint(admin_declinaison_jean)
app.register_blueprint(admin_commande)
app.register_blueprint(admin_coupe_jean)
